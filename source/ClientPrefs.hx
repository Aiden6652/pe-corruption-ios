...
class ClientPrefs {
	...
	public static var hitBoxTrans:Float = 0.40;
	...
	public static function saveSettings() {
		...
		FlxG.save.data.deleteZip = deleteZip;
		FlxG.save.data.hitBoxSpace = hitBoxSpace;
		FlxG.save.data.hitBoxShift =hitBoxShift;
		FlxG.save.data.toporbottom = toporbottom;
		FlxG.save.data.toolazytocodesomethinginsohereisatrashway = toolazytocodesomethinginsohereisatrashway;
		...
		FlxG.save.data.hitBoxTrans = hitBoxTrans;
	...
	public static function loadPrefs() {
		...
		if(FlxG.save.data.hitBoxTrans != null) {
			hitBoxTrans = FlxG.save.data.hitBoxTrans;
		}
		...
		if(FlxG.save.data.toporbottom != null) {
			toporbottom = FlxG.save.data.toporbottom;
		}
		if(FlxG.save.data.deleteZip != null) {
			deleteZip = FlxG.save.data.deleteZip;
		}
		if(FlxG.save.data.hitBoxSpace != null) {
			hitBoxSpace = FlxG.save.data.hitBoxSpace;
		}
		if(FlxG.save.data.hitBoxShift != null) {
			hitBoxShift = FlxG.save.data.hitBoxShift;
		}
		if(FlxG.save.data.toolazytocodesomethinginsohereisatrashway != null) {
			toolazytocodesomethinginsohereisatrashway = FlxG.save.data.toolazytocodesomethinginsohereisatrashway;
		}
