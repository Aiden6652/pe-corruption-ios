...
class Note extends FlxSprite
{
	...
	// V-Slice direction prefixes for note animations: noteData 0=left,1=down,2=up,3=right
	private var vSliceCol:Array<String> = ['noteLeft', 'noteDown', 'noteUp', 'noteRight'];
